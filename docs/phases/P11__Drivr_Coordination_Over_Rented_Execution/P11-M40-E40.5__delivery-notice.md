...
spec places *"Changing default-accept itself (PSG §11.6 / AOG §14)"* explicitly **Out of Scope** —
...
- **Description:** What the merge-authorization routing guard reached before this epic (one of eight
  ...
  one named residual that remains open. Implemented-track Structural diagram (AOG §17.3/§17.6),
  Mermaid, no ComfyUI.
