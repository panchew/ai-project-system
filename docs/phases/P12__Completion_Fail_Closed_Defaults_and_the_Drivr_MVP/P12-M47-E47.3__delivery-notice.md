...
merge_details:
  pr_number: 278
  pr_url: https://github.com/panchew/ai-project-system/pull/278
...
> has not happened and are unfillable at delivery time (`P10-GH-4`, restated); the PR number and
> URL are recorded because the PR exists, while the merge details remain unfillable. Merge
> authorization follows the M47 Milestone Chat's Stage-2 review, and the parent performs the merge
> (§11.6).
