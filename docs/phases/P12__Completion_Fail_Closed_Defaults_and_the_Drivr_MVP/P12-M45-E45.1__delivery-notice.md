...
merge_details:
  pr_number: 263
  pr_url: https://github.com/panchew/ai-project-system/pull/263
...
> **`pr_number`/`pr_url` are recorded now that the PR exists (PR #263).** The remaining
> `merge_details` fields describe a merge that has not happened and are **unfillable at delivery time**
