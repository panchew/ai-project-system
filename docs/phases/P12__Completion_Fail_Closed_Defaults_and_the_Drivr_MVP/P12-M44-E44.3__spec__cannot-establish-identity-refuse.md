...
flowchart TB
  ...
  EXC["the exception, and WHY it exists<br/>self-report already unverifiable (:304)<br/>a recorded declaration = same strength<br/>+ a NAMED accountable party<br/>= E42.1's opt-in, one tier down"]
