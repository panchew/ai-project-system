...
>
> **This epic now measures THREE candidates, not four:** **fable-5**, **GPT-5.6 Sol**, **Deepseek V4
> Flash** — plus the **`claude-opus-5` baseline**, which is unchanged and still the incumbent for all
> of them. **`qwen3.6:27b`'s ten existing runs are still cited, not re-run.**
>
