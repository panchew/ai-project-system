...
> **Boundary stated: where the `<function=…>` parse happens has NOT been established** — E41.2's
> record says *"the runner's parser"*, which is thin. **The verified claim is only that M42's scope
> does not include it.**
