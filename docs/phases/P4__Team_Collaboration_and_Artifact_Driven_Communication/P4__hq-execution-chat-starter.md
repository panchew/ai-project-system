# HQ EXECUTION CHAT STARTER — P4: Team Collaboration & Artifact-Driven Communication
...
Execution Mode: Phase planning (produces Milestone specifications)
Scope Rule: Plan all 4 Milestones. No scope expansion beyond documented requirements.
...
**Target Completion:** July 31, 2026 (8 weeks)

DESIGN DOCUMENTS (COMPLETE)

All design work is complete. Reference:
...
- `docs/phases/P4__Team_Collaboration_and_Artifact_Driven_Communication/P4__phase-spec.md` (Phase spec)
...
- All 4 Milestone Execution Chat Starters created
...
- Governance: `governance/PROJECT-SYSTEM-GUIDELINES.md` §13 (Chat Hierarchy)
