...
Generated 2026-07-20T01:15:36+00:00 by `bin/measure-token-burn` v1.0.0. **Aggregated numbers only** — no conversation content. Machine-readable twin: `token-burn-dataset.json`.

- Paid source: 76 harness session files, 76 with usage data, window 2026-06-12 → 2026-07-20.
...
| **hq** | n=3, calls=190, out=247,956, cc=2,050,964, cr=25,916,298 | N/A structural → G3 | GAP → G5 | GAP → G5 |
| **phase** | n=1, calls=44, out=64,850, cc=573,448, cr=4,009,560 | N/A structural → G3 | GAP → G4 | GAP → G4 |
| **milestone** | n=2, calls=237, out=220,259, cc=1,091,507, cr=41,224,209 | N/A structural → G3 | n=1, calls=35, out=57,137, cc=134,344, cr=2,914,804 | GAP → G4 |
| **epic** | N/A structural → G1 | n=41, calls=2091, out=1,739,582, cc=6,239,342, cr=212,383,725 | N/A structural → G1 | GAP → G2 |
...
|---|---|---|---|---|---|---|
| creation | unattributed | 6 | 290 | 458,146 | 3,990,575 | 33,365,839 |
| hq | mixed | 1 | 107 | 100,446 | 1,174,201 | 9,099,456 |
| phase | mixed | 5 | 701 | 878,543 | 6,258,389 | 114,687,143 |
| milestone | mixed | 12 | 1278 | 1,663,386 | 8,917,840 | 237,305,762 |
| milestone | unattributed | 2 | 38 | 55,907 | 384,090 | 1,659,865 |
...
|---|---|---|---|---|
| claude-fable-5 | 25,994 | 4,890,044 | 91,160,174 | 935,894 |
| claude-opus-4-8 | 281,945 | 15,251,215 | 233,684,045 | 2,523,051 |
| claude-sonnet-4-6 | 838 | 5,444,456 | 58,393,989 | 510,270 |
| claude-sonnet-5 | 21,862 | 8,758,035 | 377,002,444 | 1,931,602 |

## 3. Measured context load (provider-billed)

| level | first-turn context, median | per-call context, median |
|---|---|---|
| creation | 29,739 | 80,297 |
| hq | 23,051 | 101,163 |
| phase | 22,228 | 169,003 |
| milestone | 20,058 | 143,575 |
| epic | 24,636 | 81,017 |
...
| AOG (AI-OPERATING-GUIDELINES.md) | 12,733 |
| yml spec (ai-project-yml-spec.md) | 8,396 |
| generic epic starter (governance/EPIC-EXECUTION-CHAT-STARTER.md) | 903 |
| P9 phase starter | 2,687 |
| P9 phase spec | 5,949 |
| M30 milestone starter | 3,593 |
| M30 milestone spec | 5,870 |
| E30.1 epic starter | 2,997 |
| E30.1 epic spec | 3,816 |

| directory | tokens | files |
|---|---|---|
| governance/ total (*.md recursive) | 164,248 | 69 |
| governance/templates | 36,017 | 25 |
| governance/systems | 36,389 | 13 |
...
| P9-M31-E31.1-PROVE | qwen2.5-coder:14b | 759 | GAP → G9 | 941 | 20605 |
| P9-M31-E31.2-PROVE | qwen2.5-coder:14b | 837 | GAP → G9 | 1161 | 21978 |
...
| 3331978d | 2026-07-17 | milestone (first-message) | mixed (signals:planning+closure) | 89 | 177 | 885,462 | 13,793,054 | 122,823 | 24,602 |
| 6b9a1b4e | 2026-07-17 | creation (first-message) | unattributed (no-signals) | 24 | 45 | 43,874 | 1,059,289 | 19,902 | 29,749 |
| c10b3cb0 | 2026-07-17 | phase (first-message) | planning (signals) | 44 | 83 | 573,448 | 4,009,560 | 64,850 | 24,554 |
| ce8fab50 | 2026-07-17 | creation (first-message) | unattributed (no-signals) | 1 | 2 | 17,143 | 12,585 | 848 | 29,730 |
| da848017 | 2026-07-17 | hq (first-message) | planning (signals) | 38 | 71 | 203,219 | 3,017,533 | 53,818 | 25,324 |
| e92a5427 | 2026-07-17 | epic (first-message) | execution (role) | 40 | 79 | 117,086 | 3,545,647 | 61,137 | 24,632 |
| f89a3fb6 | 2026-07-17 | epic (first-message) | execution (role) | 32 | 63 | 412,029 | 8,692,353 | 47,778 | 24,641 |
| 21d4e331 | 2026-07-18 | creation (first-message) | unattributed (no-signals) | 23 | 43 | 69,970 | 1,265,825 | 19,740 | 26,447 |
| 876863bb | 2026-07-18 | epic (first-message) | execution (role) | 56 | 111 | 289,576 | 6,844,768 | 65,900 | 24,771 |
| 4d90f6f1 | 2026-07-19 | epic (first-message) | execution (role) | 49 | 97 | 114,543 | 4,096,412 | 42,807 | 24,838 |
| 4ef54b07 | 2026-07-19 | epic (first-message) | execution (role) | 62 | 124 | 168,371 | 8,622,478 | 60,567 | 35,807 |
| a8130717 | 2026-07-19 | epic (first-message) | execution (role) | 108 | 216 | 225,073 | 17,088,244 | 79,806 | 36,281 |
| ac7f394b | 2026-07-19 | milestone (first-message) | planning (signals) | 109 | 218 | 695,364 | 17,192,990 | 114,867 | 36,236 |
| dfee1a5a | 2026-07-19 | epic (first-message) | execution (role) | 117 | 290 | 234,366 | 18,113,923 | 109,372 | 35,812 |
| 1cb3da03 | 2026-07-20 | milestone (first-message) | unattributed (no-signals) | 11 | 22 | 47,266 | 528,368 | 2,658 | 35,942 |
