...
Project:
Repository:
Primary Language / Stack (if known):

## Governance
- PROJECT-SYSTEM-GUIDELINES.md version:
- AI-OPERATING-GUIDELINES.md version:
...
(e.g., define Phase, define Milestone, draft Epic spec)
